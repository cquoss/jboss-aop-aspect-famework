...
public class ExecutionMethodMatcher extends MethodMatcher
{
   ...
   public ExecutionMethodMatcher(Advisor advisor, Method method, ASTStart start, boolean matchOnAdvisor)
   {
      super(advisor, method, start, matchOnAdvisor);
   }
   ...
   protected Boolean resolvePointcut(Pointcut p)
   {
      try
      {
         if (refMethod != null) return new Boolean(p.matchesExecution(advisor, refMethod));
