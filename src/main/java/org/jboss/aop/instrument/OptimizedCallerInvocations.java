...
public class OptimizedCallerInvocations extends OptimizedBehaviourInvocations
{
         ...
         long calledHash) throws NotFoundException, CannotCompileException
   {
      ...
      CtMethod invokeNext = CtNewMethod.make(in.getReturnType(), "invokeNext", in.getParameterTypes(), in.getExceptionTypes(), null, invocation);
      invokeNext.setModifiers(in.getModifiers());
   
      String code = STANDARD_INTERCEPTOR_CODE;
      ...
      CtMethod copy = CtNewMethod.make(copyTemplate.getReturnType(), "copy",
      copyTemplate.getParameterTypes(), copyTemplate
      .getExceptionTypes(), null, invocation);
         ...
         long calledHash)  throws NotFoundException, CannotCompileException
   {
      ...
      CtMethod invokeNext = CtNewMethod.make(in.getReturnType(),
      "invokeNext", in.getParameterTypes(), in.getExceptionTypes(),
      null, invocation);
      invokeNext.setModifiers(in.getModifiers());
