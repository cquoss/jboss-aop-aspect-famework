...
public abstract class Instrumentor
{
   ...
   public static boolean isAdvisable(CtMethod method)
   {
      return
              ...
              !method.getName().endsWith(ClassAdvisor.NOT_TRANSFORMABLE_SUFFIX) &&
   ...
   public static boolean isAdvisable(CtField field)
   {
      return (field.getModifiers() & Modifier.FINAL) == 0 &&
             (!field.getName().endsWith(ClassAdvisor.NOT_TRANSFORMABLE_SUFFIX)) &&
